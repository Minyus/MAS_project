...
@#$#@#$#@
<experiments>
  <experiment name="number of trucks-norebalance" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
  ...
  <experiment name="number of trucks-rebalance" repetitions="50" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>simulated_out_of_bikes_count</metric>
    <metric>simulated_out_of_docks_count</metric>
